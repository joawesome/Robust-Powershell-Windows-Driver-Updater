...
# ---- RUN IT NOW ----
Start-Process powershell.exe -ArgumentList '-NoExit -WindowStyle Normal -ExecutionPolicy Bypass -Command "irm ''https://raw.githubusercontent.com/joawesome/Robust-Powershell-Windows-Driver-Updater/main/DriverUpdateMain.ps1'' | iex"'
